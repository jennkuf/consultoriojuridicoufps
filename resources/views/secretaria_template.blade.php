                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                {!! Html::image('img/secretaria.png', 'Icono', array('class' =>'img-circle', 'alt'=>"User Image")) !!}
                                <p>
                                    {!! session('name') !!}
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar" style="height: auto;">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="{!! URL::to('jefe_area/crear') !!}"><i class="fa fa-user-secret"></i><span>Jefes de Area</span></a></li>
                <li><a href="{!! URL::to('casos') !!}"><i class="fa fa-user-secret"></i><span>Casos</span></a></li>
                <!--<li class="treeview">
                    <a href="#">
                        <i class="fa fa-balance-scale"></i> <span>Estudiantes</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{!! URL::to('estudiantes') !!}"><i class="fa  fa-hourglass-3"></i><span>Estudiantes</span></a></li>
                    </ul>
                </li>-->
